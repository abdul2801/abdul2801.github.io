...
const CONFIG = {
      ...
      projects: [
        {
          ...
          imageUrl:
            "https://images.squarespace-cdn.com/content/v1/569805af1f4039853c5804f1/1526586326433-ER7GN1K932RALLWJENEC/SentryWire-Packet-Capture-Appliance-230-1.png?format=500w", // Replace with real image if available
        ...
        },
        {
          ...
          imageUrl:
            "https://raw.githubusercontent.com/abdul2801/queueShopper/main/screenshot.png", // Replace with real image if available
        ...
        },
        {
          ...
          imageUrl:
            "https://raw.githubusercontent.com/abdul2801/Collaborative-code-editor/main/image.png", // Replace with real image if available
  ...
  resume: {
    fileUrl: "/resume_new.pdf", // Empty fileUrl will hide the `Download Resume` button.
  },
  // 20 only
  skills: [
    "Rust",
  ...
  experiences: [
    {
      ...
      from: "December 2025",
      to: "Present",
      companyLink: "https://www.siemens.com/in/en.html",
    },
    {
      company: "Soundverse",
  ...
  publications: [
    {
      title:
        "Study of the Representational Power of Weighted Randomised Univariate Regression Tree",
      conferenceName: "",
